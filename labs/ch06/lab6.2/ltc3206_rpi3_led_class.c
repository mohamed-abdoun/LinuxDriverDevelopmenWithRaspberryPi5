// Device Datasheet https://static1.squarespace.com/static/5c155684f407b4100552994c/t/5c2d20ca0e2e7292108eadf8/1546461407535/BlinkM_datasheet.pdf
...
/* The sysfs functions */
static ssize_t sub_select(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
    char *buffer;
    struct i2c_client *client;
    struct led_priv *private;
...
static DEVICE_ATTR(sub, S_IWUSR, NULL, sub_select)
    ...
    static ssize_t rgb_select(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
    char *buffer;
...
static int __init blinkm_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    int count, ret;
    u8 value[3];
